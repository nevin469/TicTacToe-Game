...
def b_click(b):
    ...
    if b["text"] == " "and clicked == True:
        ...
        messagebox.showerror("Error", "Please enter on another button")
...
def reset():
    ...
    b7 = Button(root, text=" ", font=("Helvetica", 20), height=3, width=6, bg="Light Blue", command= lambda: b_click(b7))
    b8 = Button(root, text=" ", font=("Helvetica", 20), height=3, width=6, bg="Light Blue", command= lambda: b_click(b8))
    b9 = Button(root, text=" ", font=("Helvetica", 20), height=3, width=6, bg="Light Blue", command= lambda: b_click(b9))
...
#About me Section
def about_me():
    messagebox.showinfo("About Me", "Created by Nevin Bullywon")
...
#Create About me Menu
options_menu.add_command(label="About me", command=about_me)
